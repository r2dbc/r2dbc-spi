...
This script will bump all the POM files to `0.8.5.RELEASE`, apply a tag (`v0.8.5.RELEASE`), and then bump the version _again_ to `0.8.6.BUILD-SNAPHOT`.

From here, you can switch over to the release branch and use that tag.

```bash
$ git checkout release-0.x
$ git reset --hard v0.8.5.RELEASE
