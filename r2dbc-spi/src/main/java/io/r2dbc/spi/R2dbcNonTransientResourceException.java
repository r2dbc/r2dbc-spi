...
/**
 *  Exception thrown in case of an error that should not be retried.
 *
 *  This kind of error indicates that a deep look into the problem is required by a developer
 */
