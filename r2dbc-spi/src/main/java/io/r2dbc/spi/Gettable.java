...
/**
 * Represents a set of gettable columns or {@code OUT} parameters from a database query, later on referred to as item.
 ...
 *
 * <p>For maximum portability, items within each {@link Gettable} should be read in left-to-right order, and each item should be read only once.
 *
